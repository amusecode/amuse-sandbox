...
//             vec v = k.get_rel_vel();
//             
            double pos0x, pos0y, pos0z, vel0x, vel0y, vel0z;
...
//             universal_variable_kepler_solver(dt, mu, pos0, vel0, pos, vel);
            universal_kepler_solver(dt, mu, 0.0, pos0x, pos0y, pos0z, vel0x, vel0y, vel0z, 
              &posx, &posy, &posz, &velx, &vely, &velz);
            
            d->x = posx+new_x;
            d->y = posy+new_y;
            d->z = posz+new_z;
            d->vx = velx+central_vx;
            d->vy = vely+central_vy;
            d->vz = velz+central_vz;
