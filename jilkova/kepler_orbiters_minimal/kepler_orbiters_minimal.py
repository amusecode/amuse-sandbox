"""
Example of kepler_orbiters
"""

from amuse.units import units, nbody_system, quantities
from amuse.datamodel import Particles
from amuse.community.kepler_orbiters.interface import Kepler  # kepler from amuse/sandbox/pelupes
#from amuse.community.kepler6.interface import Kepler           # kepler_uv from amuse/sandbox/jilkova
...
def integrate_solar_system(sun, planets, time_end=5.0|units.yr, n_steps=500):
  ...
  # central particle is assumed to be at the center of the coordinate system
  ...
  print " ** evolving solar system till", time_end.in_(units.yr), ", with time-step of", dt.in_(units.yr)
  while time<=time_end:
...
if __name__ in ('__main__','__plot__'):
  ...
  integrate_solar_system(sun, planets, time_end=1.0|units.yr, n_steps=100)
