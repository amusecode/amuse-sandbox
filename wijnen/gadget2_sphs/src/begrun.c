...
printf("Timestep limiter activated\n");
#endif
    }
  ...
  if(RestartFlag == 0 || RestartFlag == 2)
...
#ifdef SPHS
      All.ArtBulkDissConst = all.ArtBulkDissConst;
#endif
	...
	readjust_timebase(All.TimeMax, all.TimeMax);
      ...
      if(ThisTask == 0)
      {
	printf("\nAllocating memory for fluid interp matrices (begrun) ... \n");
      }
...
#define MAXTAGS 300
 ...
 /* JUSTIN'S CODE */
#ifdef LIMIT_TIMESTEPS
      strcpy(tag[nt], "TimeStepFac");
      addr[nt] = &All.TimeStepFac;
      id[nt++] = DOUBLE;
#endif
#ifdef FIXEDPOT
      strcpy(tag[nt],"FixedPotential");
      addr[nt] = &All.FixedPotential;
      id[nt++] = INT;
#endif
#ifdef ICSMOOTH
      strcpy(tag[nt],"FixedPressure");
      addr[nt] = &All.FixedPressure;
      id[nt++] = DOUBLE;
#endif
#ifdef GLASSIFY
      strcpy(tag[nt],"GlassTol");
      addr[nt] = &All.GlassTol;
      id[nt++] = DOUBLE;
#endif
#ifdef SPHS
      strcpy(tag[nt], "ArtBulkDissConst");
      addr[nt] = &All.ArtBulkDissConst;
      id[nt++] = DOUBLE;
#endif
