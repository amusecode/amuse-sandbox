  ...
  do				/* main loop */
    {
      ...
      /* JUSTIN'S FIXEDPOT code */ 
#ifdef FIXEDPOT
      fixed_potential();            /* compute accelerations in a fixed potential if required
				     * N.B need to do this first so that FixPot and FixAccel
				     * do not contain zero values for the first timestep 
				     */
#endif
      ...
      if(ThisTask == 0)
	{
	  printf("*** FINISHED MASSIFY *** bye bye!\n");
	  fflush(stdout);
	}
      endrun(0);
#endif
      ...
      if(ThisTask == 0)
	{
	  printf("*** FINISHED GLASSIFY *** bye bye!\n");
	  fflush(stdout);
	}
      endrun(0);
#endif
...
void energy_statistics(void)
{
 ...
 %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g\n",
	      ...
	      SysState.MassComp[5],
	      SysState.MomentumComp[0][0],SysState.MomentumComp[0][1],SysState.MomentumComp[0][2],
              SysState.AngMomentumComp[0][0],SysState.AngMomentumComp[0][1],SysState.AngMomentumComp[0][2],
              SysState.MomentumComp[1][0],SysState.MomentumComp[1][1],SysState.MomentumComp[1][2],
              SysState.AngMomentumComp[1][0],SysState.AngMomentumComp[1][1],SysState.AngMomentumComp[1][2],
              SysState.MomentumComp[2][0],SysState.MomentumComp[2][1],SysState.MomentumComp[2][2],
              SysState.AngMomentumComp[2][0],SysState.AngMomentumComp[2][1],SysState.AngMomentumComp[2][2],
              SysState.MomentumComp[3][0],SysState.MomentumComp[3][1],SysState.MomentumComp[3][2],
              SysState.AngMomentumComp[3][0],SysState.AngMomentumComp[3][1],SysState.AngMomentumComp[3][2],
              SysState.MomentumComp[4][0],SysState.MomentumComp[4][1],SysState.MomentumComp[4][2],
              SysState.AngMomentumComp[4][0],SysState.AngMomentumComp[4][1],SysState.AngMomentumComp[4][2],
              SysState.MomentumComp[5][0],SysState.MomentumComp[5][1],SysState.MomentumComp[5][2],
              SysState.AngMomentumComp[5][0],SysState.AngMomentumComp[5][1],SysState.AngMomentumComp[5][2]
              );
