...
-------------------------------------------------------------------------
SPHS Add-ons \n
- \b FIXEDPOT \n This allows for a fixed potential. Use the FixedPotential integar in the parameter file to set which potential to use in fixed_potential.c. At the moment, the potentials must have all of their parameters set at compile time
Choice of Kernel (pick *one* of): \n
- \b CS \n Standard cubic spline kernel
- \b CT \n Core Triangle kernel
Initial conditions: \n
- \b SPHS \n turn on SPHS
