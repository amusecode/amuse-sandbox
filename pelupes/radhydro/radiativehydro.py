...
class RadiativeHydro(object):
    ...
    def evolve_model(self,tend):
        ...
        rad_attributes_to_update,hydro_attributes_to_update=self.attributes_to_update()

        if self.constant_heating is not None:
          self.rad.gas_particles.du_dt=self.constant_heating
    ...
    def attributes_to_update(self):
        ...
        if hasattr(self.rad.parameters,"momentum_kicks_flag"):
        ...
        if hasattr(self.hydro.parameters,"isothermal_flag"):
