...
def test(evolver, rad_parameters=None,dt=1. | units.Myr ):    
  N=100000
  Ns=10
  L=15. | units.kpc
...
if __name__=="__main__":
  ...
  t2=time.time()
  print "test7: 10 freq, dynamic, thermal solver",
  print t2-t1,"sec"
  
  t1=time.time()
  label="test8"
  test(radhydro_evolve, dict(number_of_freq_bins=5, blackbody_spectrum_flag=1,thermal_evolution_flag=1),dt=0.5|units.Myr )
  t2=time.time()
