...
#  code=grav_with_se(converter=conv,timestep=timestep,begin_time=age)  
  code=forwarding_class_client(grav_with_se,
   code_kwarg=dict(converter=conv,timestep=timestep,begin_time=age),
   server_kwarg=dict(label="local",redirection="none") )
