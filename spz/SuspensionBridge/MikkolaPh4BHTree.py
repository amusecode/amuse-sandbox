...
def validate_bridge():
  ...
  convert_bul = nbody_system.nbody_to_si(1.e5 | units.MSun, 1.0 | units.parsec)
...
#  cluster=sys_from_file(PhiGRAPE, "PlummerN512.stoa", convert_bul, eps_clu)
#  galaxy=sys_from_file(BHTree, "KingW7N2k.stoa", convert_gal, eps_gal)
#  nuclear_cl=sys_from_file(PhiGRAPE, "BinaryN2.stoa", convert_nsc, eps_nsc)
#  cluster=sys_from_file(PhiGRAPE, "BinaryN2.stoa", convert_bul, eps_clu)
#  galaxy=sys_from_file(BHTree, "BinaryN2.stoa", convert_gal, eps_gal)
#  galaxy=sys_from_file(BHTree, "KingW7N2k.stoa", convert_gal, eps_gal)
#  galaxy=parts_from_file("KingW7N10k.stoa")
