...
#    com_gal = galaxy.particles.center_of_mass()
    com_cl = cluster.particles.center_of_mass()
    com_nsc = nuclear_cl.particles.center_of_mass()

    tl.plot(galaxy.particles.x.value_in(units.parsec), galaxy.particles.y.value_in(units.parsec), 'g.')
    tl.plot(cluster.particles.x.value_in(units.parsec), cluster.particles.y.value_in(units.parsec), 'b.')
    tl.plot(nuclear_cl.particles.x.value_in(units.parsec), nuclear_cl.particles.y.value_in(units.parsec), 'r.')
    tr.plot(galaxy.particles.x.value_in(units.parsec), galaxy.particles.y.value_in(units.parsec), 'g.')
    bl.plot((cluster.particles.x-com_cl.x).value_in(units.parsec), (cluster.particles.y-com_cl.y).value_in(units.parsec), 'b.')
    bl.set_xlim(-10, 10)
    bl.set_ylim(-10, 10)
#    br.plot((nuclear_cl.particles.x-com_nsc.x).value_in(units.parsec), (nuclear_cl.particles.y-com_nsc.y).value_in(units.parsec), 'r.')
    br.plot((nuclear_cl.particles.x).value_in(units.parsec), (nuclear_cl.particles.y).value_in(units.parsec), 'r.')
