...
def main(N=10, W0=7.0, t_end=10, dt=1, filename="nbody.hdf5", Rvir=1, Mmin=0.1, Mmax=100, rgc=8500., vgc=220):
    ...
    gravity.timestep = min(dt/4., t_orb/256.)
    time = 0.0 | t_end.unit
    while time < t_end:
        time += dt
...
#        print "pos=", gravity.particles.center_of_mass()
        Etot_prev = Etot
