...
The data points you give in your data series should be three dimentions, like:[x_value, y_value, dx, dy].
...
(function ($) {
    ...
    function init(plot) {
        ...
        function drawSeries(plot, ctx, series) {
            ...
            if (!series.show || series.data.length < 1 ||  series.data[0].length < 4) {
                return;
            }
            ...
            for (i = 0; i < points.length; i++) {
                if (points[i].length < 4 || points[i][1] === null) {
                    continue;
                }
