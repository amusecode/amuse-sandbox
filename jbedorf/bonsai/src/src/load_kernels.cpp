...
#ifdef USE_CUDA
  compactCount.load_source("./scanKernels.ptx", "");
  compactCount.create("compact_count");
  
  exScanBlock.load_source("./scanKernels.ptx", "");
  exScanBlock.create("exclusive_scan_block");
  
  compactMove.load_source("./scanKernels.ptx", "");
  compactMove.create("compact_move");
  
  splitMove.load_source("./scanKernels.ptx", "");
  splitMove.create("split_move");
  
  sortCount.load_source("./sortKernels.ptx", "");
  sortCount.create("sort_count");

  sortMove.load_source("./sortKernels.ptx", "");
  sortMove.create("sort_move_stage_key_value");  

  extractInt.load_source("./sortKernels.ptx", "");
  extractInt.create("extractInt");  
  
  fillSequence.load_source("./sortKernels.ptx", "");
  fillSequence.create("fillSequence");  
  
  reOrderKeysValues.load_source("./sortKernels.ptx", "");
  reOrderKeysValues.create("reOrderKeysValues");    
  
  extractKeyAndPerm.load_source("./sortKernels.ptx", "");
  extractKeyAndPerm.create("extractKeyAndPerm");  
  
  convertKey64to96.load_source("./sortKernels.ptx", "");
  convertKey64to96.create("convertKey64to96");
  
  dataReorderR4.load_source("./sortKernels.ptx", "");
  dataReorderR4.create("dataReorderR4");  
  
  dataReorderF2.load_source("./sortKernels.ptx", "");
  dataReorderF2.create("dataReorderF2");  

  dataReorderI1.load_source("./sortKernels.ptx", "");
...
#ifdef USE_CUDA
  build_key_list.load_source("./build_tree.ptx", "");
  build_valid_list.load_source("./build_tree.ptx", "");
  build_nodes.load_source("./build_tree.ptx", "");
  link_tree.load_source("./build_tree.ptx", "");
//  link_tree.load_source("./build_tree.cubin", "");
  define_groups.load_source("./build_tree.ptx", "");
  build_level_list.load_source("./build_tree.ptx", "");
  boundaryReduction.load_source("./build_tree.ptx", "");
  build_body2group_list.load_source("./build_tree.ptx", "");
  store_groups.load_source("./build_tree.ptx", "");
  expand_leaflist.load_source("./build_tree.ptx", "");
  
  build_phkey_list.load_source("./build_tree.ptx", "");
...
#ifdef USE_CUDA
  propsNonLeaf.load_source("./compute_properties.ptx", "");
  propsLeaf.load_source("./compute_properties.ptx", "");
  propsScaling.load_source("./compute_properties.ptx", "");

  propsNonLeafD.load_source("./compute_propertiesD.ptx", "", "", -1, CU_TARGET_COMPUTE_20);
  propsLeafD.load_source("./compute_propertiesD.ptx", "", "", -1, CU_TARGET_COMPUTE_20);
  propsScalingD.load_source("./compute_propertiesD.ptx", "", "",-1, CU_TARGET_COMPUTE_20);
  
  copyNodeDataToGroupData.load_source("./compute_propertiesD.ptx", "");
...
#ifdef USE_CUDA
  getTNext.load_source("./timestep.ptx", "", "", -1, CU_TARGET_COMPUTE_20);
  predictParticles.load_source("./timestep.ptx", "", "", -1, CU_TARGET_COMPUTE_20);
  getNActive.load_source("./timestep.ptx", "", "", -1, CU_TARGET_COMPUTE_20);
  approxGrav.load_source("./dev_approximate_gravity.ptx", "", "", 64);
//   approxGrav.load_source("./dev_approximate_gravity.cubin", "", "", 64);
  correctParticles.load_source("./timestep.ptx", "", "", -1, CU_TARGET_COMPUTE_20);
  computeDt.load_source("./timestep.ptx", "", "", -1, CU_TARGET_COMPUTE_20);
  computeEnergy.load_source("./timestep.ptx", "", "", -1, CU_TARGET_COMPUTE_20);
  setActiveGrps.load_source("./timestep.ptx", "", "", -1, CU_TARGET_COMPUTE_20);
  distanceCheck.load_source("./timestep.ptx", "", "", -1, CU_TARGET_COMPUTE_20);  
  
  approxGravLET.load_source("./dev_approximate_gravity_let.ptx", "", "", 64);  
  /* create kernels */
