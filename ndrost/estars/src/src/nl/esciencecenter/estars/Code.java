...
import nl.esciencecenter.estars.glue.Star;
...
public class Code implements CodeInterface {
    ...
    @Override
    public int set_color(IntBuffer index_of_the_particle, DoubleBuffer red, DoubleBuffer green, DoubleBuffer blue, DoubleBuffer alpha,
            int npoints) {
    ...
    public int new_particle(IntBuffer index_of_the_particle, IntBuffer type, DoubleBuffer x, DoubleBuffer y,
            DoubleBuffer z, DoubleBuffer radius, DoubleBuffer red, DoubleBuffer green, DoubleBuffer blue, DoubleBuffer alpha, int npoints) {
