...
class Gadget2Interface(
    ...
    def new_dm_particle():
        ...
        function.addParameter('ptype', dtype='int32', direction=function.IN, default=1)
    ...
    def get_ptype():
        ...
        function.addParameter('index_of_the_particle', dtype='int32', direction=function.IN,
            description = "Index of the particle to get the state from. This index must have been returned by an earlier call to :meth:`new_particle`")
        function.addParameter('ptype', dtype='int32', direction=function.OUT, description = "The current type of the particle")
        function.addParameter('length', 'int32', function.LENGTH)
        function.result_type = 'int32'
        function.result_doc = """
        0 - OK
    ...
    def set_ptype():
        ...
        function.addParameter('index_of_the_particle', dtype='int32', direction=function.IN,
            description = "Index of the particle for which the state is to be updated. This index must have been returned by an earlier call to :meth:`new_particle`")
        function.addParameter('ptype', dtype='int32', direction=function.IN, description = "The new type of the particle")
        function.addParameter('length', 'int32', function.LENGTH)
        function.result_type = 'int32'
        function.result_doc = """
        0 - OK
...
# setting/ getting parameters
    ...
    def get_epsilon():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter('epsilon', dtype='float64', direction=function.OUT, unit=generic_unit_system.length,
    ...
    def set_epsilon():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter('epsilon', dtype='float64', direction=function.IN, unit=generic_unit_system.length,
            description = "epsilon, a softening parameter for gravitational potentials with point particles")
        function.result_type = 'int32'
        return function
        
    @legacy_function
    def get_epsilon_ptype2():
        function = LegacyFunctionSpecification()
        function.addParameter('epsilon_ptype2', dtype='float64', direction=function.OUT, unit=generic_unit_system.length,
            description = "epsilon ptype 2, a softening parameter for gravitational potentials with point particles")
        function.result_type = 'int32'
        return function
        
    @legacy_function
    def set_epsilon_ptype2():
        function = LegacyFunctionSpecification()
        function.addParameter('epsilon_ptype2', dtype='float64', direction=function.IN, unit=generic_unit_system.length,
            description = "epsilon ptype 2, a softening parameter for gravitational potentials with point particles")
        function.result_type = 'int32'
        return function
        
    @legacy_function
    def get_epsilon_ptype3():
        function = LegacyFunctionSpecification()
        function.addParameter('epsilon_ptype3', dtype='float64', direction=function.OUT, unit=generic_unit_system.length,
            description = "epsilon ptype 3, a softening parameter for gravitational potentials with point particles")
        function.result_type = 'int32'
        return function
        
    @legacy_function
    def set_epsilon_ptype3():
        function = LegacyFunctionSpecification()
        function.addParameter('epsilon_ptype3', dtype='float64', direction=function.IN, unit=generic_unit_system.length,
            description = "epsilon ptype 3, a softening parameter for gravitational potentials with point particles")
        function.result_type = 'int32'
        return function
        
    @legacy_function
    def get_epsilon_ptype4():
        function = LegacyFunctionSpecification()
        function.addParameter('epsilon_ptype4', dtype='float64', direction=function.OUT, unit=generic_unit_system.length,
            description = "epsilon ptype 4, a softening parameter for gravitational potentials with point particles")
        function.result_type = 'int32'
        return function
        
    @legacy_function
    def set_epsilon_ptype4():
        function = LegacyFunctionSpecification()
        function.addParameter('epsilon_ptype4', dtype='float64', direction=function.IN, unit=generic_unit_system.length,
            description = "epsilon ptype 4, a softening parameter for gravitational potentials with point particles")
        function.result_type = 'int32'
        return function
        
    @legacy_function
    def get_epsilon_ptype5():
        function = LegacyFunctionSpecification()
        function.addParameter('epsilon_ptype5', dtype='float64', direction=function.OUT, unit=generic_unit_system.length,
            description = "epsilon ptype 5, a softening parameter for gravitational potentials with point particles")
        function.result_type = 'int32'
        return function
        
    @legacy_function
    def set_epsilon_ptype5():
        function = LegacyFunctionSpecification()
        function.addParameter('epsilon_ptype5', dtype='float64', direction=function.IN, unit=generic_unit_system.length,
            description = "epsilon ptype 5, a softening parameter for gravitational potentials with point particles")
        function.result_type = 'int32'
        return function
    ...
    @legacy_function
    def get_softening_disk_max_phys():
        function = LegacyFunctionSpecification()
        function.addParameter('softening_disk_max_phys', dtype='d', direction=function.OUT,
            description = "The maximum physical softening of dm particles for comoving integrations.")
        function.result_type = 'i'
        return function
    @legacy_function
    def set_softening_disk_max_phys():
        function = LegacyFunctionSpecification()
        function.addParameter('softening_disk_max_phys', dtype='d', direction=function.IN,
            description = "The maximum physical softening of dm particles for comoving integrations.")
        function.result_type = 'i'
        return function
    
    @legacy_function
    def get_softening_bulge_max_phys():
        function = LegacyFunctionSpecification()
        function.addParameter('softening_bulge_max_phys', dtype='d', direction=function.OUT,
            description = "The maximum physical softening of dm particles for comoving integrations.")
        function.result_type = 'i'
        return function
    @legacy_function
    def set_softening_bulge_max_phys():
        function = LegacyFunctionSpecification()
        function.addParameter('softening_bulge_max_phys', dtype='d', direction=function.IN,
            description = "The maximum physical softening of dm particles for comoving integrations.")
        function.result_type = 'i'
        return function
    
    @legacy_function
    def get_softening_stars_max_phys():
        function = LegacyFunctionSpecification()
        function.addParameter('softening_stars_max_phys', dtype='d', direction=function.OUT,
            description = "The maximum physical softening of dm particles for comoving integrations.")
        function.result_type = 'i'
        return function
    @legacy_function
    def set_softening_stars_max_phys():
        function = LegacyFunctionSpecification()
        function.addParameter('softening_stars_max_phys', dtype='d', direction=function.IN,
            description = "The maximum physical softening of dm particles for comoving integrations.")
        function.result_type = 'i'
        return function
    
    @legacy_function
    def get_softening_bndry_max_phys():
        function = LegacyFunctionSpecification()
        function.addParameter('softening_bndry_max_phys', dtype='d', direction=function.OUT,
            description = "The maximum physical softening of dm particles for comoving integrations.")
        function.result_type = 'i'
        return function
    @legacy_function
    def set_softening_bndry_max_phys():
        function = LegacyFunctionSpecification()
        function.addParameter('softening_bndry_max_phys', dtype='d', direction=function.IN,
            description = "The maximum physical softening of dm particles for comoving integrations.")
        function.result_type = 'i'
        return function
...
class Gadget2(GravitationalDynamics, GravityFieldCode):
    ...
    def define_parameters(self, object):
        object.add_method_parameter(
            ...
            default_value = 1440000.0 | generic_unit_system.length * generic_unit_system.length
        )
        ...
        object.add_method_parameter(
            ...
            "set_epsilon",
            "halo_epsilon", 
            "The ptype 1 gravitational smoothing epsilon.", 
            default_value = 0.01 | generic_unit_system.length
        )
        ...
        object.add_method_parameter(
            ...
            "set_epsilon_ptype2",
            "disk_epsilon", 
            "The ptype 2 gravitational smoothing epsilon.", 
            default_value = 0.01 | generic_unit_system.length
        )
        ...
        object.add_method_parameter(
            ...
            "set_epsilon_ptype3",
            "bulge_epsilon", 
            "The ptype 3 gravitational smoothing epsilon.", 
            default_value = 0.01 | generic_unit_system.length
        )
        ...
        object.add_method_parameter(
            ...
            "set_epsilon_ptype4",
            "stars_epsilon", 
            "The ptype 4 gravitational smoothing epsilon.", 
            default_value = 0.01 | generic_unit_system.length
        )
        ...
        object.add_method_parameter(
            ...
            "set_epsilon_ptype5",
            "bndry_epsilon", 
            "The ptype 5 gravitational smoothing epsilon.", 
            default_value = 0.01 | generic_unit_system.length
        )
        ...
        object.add_method_parameter(
            ...
            "The maximum physical softening of type 0 (gas) particles for comoving integrations.", 
        ...
        object.add_method_parameter(
            ...
            "The maximum physical softening of type 1 particles for comoving integrations.", 
            default_value = 0.0 | generic_unit_system.length
        )
        
        object.add_method_parameter(
            "get_softening_disk_max_phys", 
            "set_softening_disk_max_phys",
            "softening_disk_max_phys", 
            "The maximum physical softening of type 2 particles for comoving integrations.", 
            default_value = 0.0 | generic_unit_system.length
        )
        
        object.add_method_parameter(
            "get_softening_bulge_max_phys", 
            "set_softening_bulge_max_phys",
            "softening_bulge_max_phys", 
            "The maximum physical softening of type 3 particles for comoving integrations.", 
            default_value = 0.0 | generic_unit_system.length
        )
        
        object.add_method_parameter(
            "get_softening_stars_max_phys", 
            "set_softening_stars_max_phys",
            "softening_stars_max_phys", 
            "The maximum physical softening of type 4 particles for comoving integrations.", 
            default_value = 0.0 | generic_unit_system.length
        )
        
        object.add_method_parameter(
            "get_softening_bndry_max_phys", 
            "set_softening_bndry_max_phys",
            "softening_bndry_max_phys", 
            "The maximum physical softening of type 5 particles for comoving integrations.", 
            default_value = 0.0 | generic_unit_system.length
        )
    ...
    def define_particle_sets(self, object):
        ...
        object.add_setter('dm_particles', 'set_ptype')
        object.add_getter('dm_particles', 'get_ptype')
